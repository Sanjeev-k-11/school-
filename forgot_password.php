                                 ...
                                 if ($insert_stmt = mysqli_prepare($link, $insert_sql)) {
                                     ...
                                     if (mysqli_stmt_execute($insert_stmt)) {
                                         ...
                                         try {
                                            ...
                                            $mail->Body = '
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
    <h2 style="color: #1e3a8a; text-align: center;">Admin Password Reset OTP</h2>
    <p style="color: #334155; font-size: 16px;">
        Hello,
    </p>
    <p style="color: #334155; font-size: 16px;">
        You requested a password reset for your <strong>Admin</strong> account.
    </p>
    <div style="background: #e0f2fe; padding: 15px; border-left: 4px solid #0284c7; margin: 20px 0; border-radius: 8px; text-align: center;">
        <span style="font-size: 20px; font-weight: bold; color: #0c4a6e;">Your OTP:</span><br>
        <span style="font-size: 28px; font-weight: bold; color: #0284c7;">' . htmlspecialchars($otp) . '</span>
    </div>
    <p style="color: #334155; font-size: 16px;">
    ...
    <p style="color: #475569; font-size: 14px; margin-top: 30px;">
        Thank you,<br>
        <strong>https://school.mednova.store</strong>
    </p>
</div>';

                                            $mail->AltBody = "Hello,\n\nYou requested a password reset for your Admin account. Your One-Time Password (OTP) is: " . $otp . "\n\nThis OTP is valid for " . OTP_EXPIRY_MINUTES . " minutes.\n\nIf you did not request a password reset, please ignore this email.\n\nThank you,\nYour School System";
