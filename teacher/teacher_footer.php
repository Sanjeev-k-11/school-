...
// $principal_name = "Dr. Anjali Sharma";
$owner_name = "Mr. Vishal Kumar";

// --- Website Creator Information ---
$creator_name = "Sanjeev Kumar"; // Replace with your name
$creator_email = "dev606733@gmail.com"; // Replace with your email
$creator_phone="9534757076";
?>
    </main> <!-- This closes the <main> tag that should be opened in a header file -->

    <footer class="bg-gray-900 text-gray-300 pt-12 pb-8 mt-12 no-print">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="mt-4 space-y-2">
                        <a href="./teacher_dashboard.php" class="block text-sm hover:underline text-indigo-400">Dashboard</a>
                        <a href="./view_my_timetable.php" class="block text-sm hover:underline text-indigo-400">My Timetable</a>
                        <a href="./student-list.php" class="block text-sm hover:underline text-indigo-400">My Students</a>
                    </div>
                </div>
...
<p class="text-xs mt-2 text-gray-400">
    ...
    (
    <a href="mailto:<?php echo htmlspecialchars($creator_email); ?>" class="hover:underline text-indigo-400">
        <?php echo htmlspecialchars($creator_email); ?>
    </a>
    |
    <a href="tel:<?php echo htmlspecialchars($creator_phone); ?>" class="hover:underline text-indigo-400">
        Phone_No.
    </a>
    )
</p>
