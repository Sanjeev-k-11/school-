...
define('SMTP_USERNAME', 'hvsjd@ghg.com'); // Your full email address
define('SMTP_PASSWORD', 'evhh hhhh jhhh hhhh'); // Your email password or app password
define('SMTP_PORT', 465); // e.g., 587 for TLS, 465 for SSL
define('SMTP_ENCRYPTION', 'ssl'); // 'tls' or 'ssl'

// Email details
define('MAIL_FROM_EMAIL', 'gsggs@gmail.com'); // Sender email address
