     ...
     <div class="w-full max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
         ...
         <?php if (!empty($students)): ?>
             ...
             <div class="flex justify-end mb-4">
                  <a href="./download_students_excel.php<?php echo $isFeesDueFilter ? '?filter=fees_due' : ''; ?>" class="inline-flex items-center bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-md font-medium text-sm transition flex-shrink-0 no-underline" title="Download CSV with <?php echo $isFeesDueFilter ? 'students with fees due' : 'all students'; ?> details">
